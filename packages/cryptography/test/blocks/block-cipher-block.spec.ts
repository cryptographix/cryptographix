...
describe('BlockCipherEncoder', () => EncoderTester.test(BlockCipherEncoder, [
  ...
  // -ECB
  {
    ...
    settings: {
      algorithm: 'des',
      mode: 'ecb',
      key: bytes('0101010101010101')
    },
    content: bytes('8000000000000000'),
    expectedResult: bytes('95F8A5E5DD31D900')
  },
  {
    name: "DES",
    settings: {
      algorithm: 'des',
      mode: 'ecb',
      key: bytes('7CA110454A1A6E57')
    },
    content: bytes('01A1D6D039776742'),
    expectedResult: bytes('690F5B0D9A26939B')
  },
  ...
  // -ECB
  {
    ...
    content: bytes('E4FC19D69463B783'),
    expectedResult: bytes('0011223344556677')
  },
  {
    name: "DES2",
    settings: {
      algorithm: 'des2',
      mode: 'ecb',
      key: bytes('2BD6459F82C5B300952C49104881FF48')
    },
    content: bytes('8598538A8ECF117D'),
    expectedResult: bytes('EA024714AD5C4D84')
  },
  ...
  // -ECB
  {
    ...
    settings: {
      algorithm: 'des3',
      mode: 'ecb',
      key: bytes('000102030405060708090A0B0C0D0E0F1011121314151617')
    },
    content: bytes('982662605553244D'),
    expectedResult: bytes('0011223344556677')
  },
  {
    name: "DES3",
    settings: {
      algorithm: 'des3',
      mode: 'ecb',
      key: bytes('2BD6459F82C5B300952C49104881FF482BD6459F82C5B300')
    },
    content: bytes('8598538A8ECF117D'),
    expectedResult: bytes('EA024714AD5C4D84')
  },
