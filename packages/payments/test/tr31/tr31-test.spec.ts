...
//    let block = new TR31BuilderBlock(bs);
    ...
    let kbpkKey = ByteArray.fromString('88E1AB2A2E3DD38C1FA039A536500CC8A87AB9D62DC92C01058FA79F44657DE6','hex');
    ...
    let examplePadding = ByteArray.fromString('1C2965473CE206BB855B01533782','hex');

    tr31.setBlockHeader( 'D0112P0AE00E0000' )
      .setBlockKeyData( ByteArray.fromString('3F419E1CB7079442AA37474C2EFBF8B8', 'hex') )
